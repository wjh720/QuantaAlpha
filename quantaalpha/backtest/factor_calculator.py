...
class QlibDataProvider:
    ...
    def get_stock_data(self, 
        ...
        instruments = instruments or resolve_qlib_market(
            self.data_config.get('market'),
            region=self.data_config.get('region'),
            provider_uri=self.data_config.get('provider_uri'),
        )
